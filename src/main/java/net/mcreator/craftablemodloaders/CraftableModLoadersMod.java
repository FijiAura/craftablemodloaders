 ...
 *
 *    Keep the ElementsCraftableModLoadersMod object in this class and all calls to this object
...
public class CraftableModLoadersMod {
	...
	@Mod.Instance(MODID)
	public static CraftableModLoadersMod instance;
	public ElementsCraftableModLoadersMod elements = new ElementsCraftableModLoadersMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsCraftableModLoadersMod.GuiHandler());
